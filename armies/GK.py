            ...
            match (weapon):
                ...
                case "incinerator":
                    ...
                    if self.amount5_inci == 0:
                        self.ranged_weapons5.append([1,"d6","torrent",6,1,1,{"ignore cover":True}])
                        self.amount5_inci += 1
                    else:
                        for asdf in self.ranged_weapons5:
                            if "ignore cover" in asdf[6]:
                                asdf[0] += 1
                case _:
                    pass
            ...
            match (weapon):
                ...
                case "incinerator":
                    ...
                    if self.amount10_inci == 0:
                        self.ranged_weapons10.append([1,"d6","torrent",6,1,1,{"ignore cover":True}])
...
class Purifiers(PowerArmor):
    def __init__(self, weapons_list5: list[str]|None = None, weapons_list10: list[str]|None = None, cover: bool = False, crowe = False, stealth = False):
        ...
        if crowe:
            ...
            self.ranged_weapons5.append([5,2,3,4,2,1,{"anti_infantry": 2, "ignore cover":True}])
            self.ranged_weapons10.append([5,2,3,4,2,1,{"anti_infantry": 2, "ignore cover":True}])
        else:
            self.ranged_weapons5.append([5,1,3,4,2,1,{"anti_infantry": 2, "ignore cover":True}])
            self.ranged_weapons10.append([5,1,3,4,2,1,{"anti_infantry": 2, "ignore cover":True}])
...
class Castellan_Crowe(Purifiers):
    def __init__(self, weapons_list5: list[str] = ["stormbolter"], weapons_list10: list[str] = ["stormbolter"], cover: bool = False,
     crowe = False, stealth = False):
        ...
        self.invul = 4
        self.ranged_weapons5[0][0] = 1
        self.ranged_weapons5[1][1] = 3
        self.ranged_weapons5[1][2] = 2
        if crowe:
